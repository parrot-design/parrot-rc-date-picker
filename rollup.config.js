    ...
    output: [
        ...
        },
        {
            ...
            globals:{
                ...
                '@parrotjs/react-transition-fade':'ParrotRcTransitionFade'
            },
            plugins: [terser()],
        },
    ],
    external:['react','@parrotjs/classnames','@parrotjs/react-transition-group','@parrotjs/react-hooks','@parrotjs/react-transition-fade'], 
    plugins: [
        typescript({
            tsconfigOverride: {
                compilerOptions: {
